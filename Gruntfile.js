module.exports = function ( grunt ) {
  ...
  grunt.registerTask( 'build', [
    'clean:project', 'html2js', 'jshint', 'less:build',
  ...
  grunt.registerTask('initCordova', 'Generate the cordova files.',[
    'clean:cordova',
    'mkdir:cordova',
  ...
  grunt.registerTask('buildCordova', 'Build cordova platforms.', [
    'cordovacli:build',
  ]);

  grunt.registerTask('runCordova', 'Run on device.', [
    'cordovacli:run'
  ]);
};
